...
EXCEL_SOURCE = r"\\10.211.34.118\api\trelix\miv5000"
...
HEADER_ALIASES = {
	...
	"username": ["miv5000 username", "putty username", "username", "user"],
	"password": ["miv5000 password", "putty password", "password", "pass"],
}
...
def load_servers(source_path):
	"""Read MIV5000 server details from the shared Excel file."""
